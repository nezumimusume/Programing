...
@xcopy /Y /I "%CURRENT_DIR%\..\GameTemplate\Game\Assets\shader" "%CURRENT_DIR%\%SAMPLE_FOLDER%\Game\Resource\shader"
@xcopy /Y /I "%CURRENT_DIR%\..\GameTemplate\Game\Assets\font" "%CURRENT_DIR%\%SAMPLE_FOLDER%\Game\Resource\font"
